(() => {
    ...
    function navigation_Navigation({swiper, extendParams, on, emit}) {
        extendParams({
            navigation: {
                nextEl: null,
                prevEl: null,
    ...
    function pagination_Pagination({swiper, extendParams, on, emit}) {
    ...
    function initSliders() {
        ...
        if (heroTrackSelector && heroMainSelector) {
            let heroTrackSlider = new core(heroTrackSelector, {
                modules: [ Autoplay ],
                slidesPerView: 4,
                direction: "horizontal",
                spaceBetween: 10,
        ...
        if (document.querySelector(".product-parts__slider")) {
            new core(".product-parts__slider", {
                modules: [ Pagination, Navigation ],
                slidesPerView: 1,
                slidesPerGroup: 1,
                pagination: {
    ...
    da.init();
    if (document.querySelector("#slider")) nouislider.create(document.querySelector("#slider"), {
        start: [ 5e3, 35e4 ],
        connect: true,
        range: {
            min: 0,
    ...
    if (document.querySelector("#slider-2")) nouislider.create(document.querySelector("#slider-2"), {
        start: [ 100, 220 ],
        connect: true,
        range: {
            min: 90,
    ...
    if (document.querySelector("#slider-3")) nouislider.create(document.querySelector("#slider-3"), {
        start: [ 50, 100 ],
        connect: true,
        range: {
            min: 50,
    ...
    if (catalogToggle) catalogToggle.addEventListener("click", (event => {
        ...
        if (window.innerWidth > 1150) functions_menuClose();
    ...
    if (deliveryMenu) deliveryMenu.addEventListener("click", (e => {
        const {target} = e;
        if (!target.classList.contains("active")) if (target.dataset.tab === "delivery") {
            document.querySelectorAll(".delivery__tab").forEach((item => {
                if (item.classList.contains("active")) item.classList.remove("active");
                if (item.dataset.tab === "delivery") item.classList.add("active");
            }));
            deliveryTabContent.forEach((item => {
                if (item.dataset.content !== "delivery" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
            deliveryDescriptionItems.forEach((item => {
                if (item.dataset.content !== "delivery" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
            if (document.querySelector(".delivery__cards").classList.contains("active")) document.querySelector(".delivery__cards").classList.remove("active");
            ...
            document.querySelectorAll(".delivery__tab").forEach((item => {
                if (item.classList.contains("active")) item.classList.remove("active");
                if (item.dataset.tab === "refund") item.classList.add("active");
            }));
            deliveryTabContent.forEach((item => {
                if (item.dataset.content !== "refund" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
            deliveryDescriptionItems.forEach((item => {
                if (item.dataset.content !== "refund" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
            if (!document.querySelector(".delivery__cards").classList.contains("active")) document.querySelector(".delivery__cards").classList.add("active");
    ...
    if (paymentMenu) paymentMenu.addEventListener("click", (e => {
        const {target} = e;
        if (!target.classList.contains("active")) if (target.dataset.tab === "cash") {
            document.querySelectorAll(".payment__tab").forEach((item => {
                if (item.classList.contains("active")) item.classList.remove("active");
                if (item.dataset.tab === "cash") item.classList.add("active");
            }));
            paymentTabContent.forEach((item => {
                if (item.dataset.content !== "cash" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
        } else if (target.dataset.tab === "company") {
            document.querySelectorAll(".payment__tab").forEach((item => {
                if (item.classList.contains("active")) item.classList.remove("active");
                if (item.dataset.tab === "company") item.classList.add("active");
            }));
            paymentTabContent.forEach((item => {
                if (item.dataset.content !== "company" && item.classList.contains("active")) item.classList.remove("active"); else item.classList.add("active");
            }));
        }
    }));
    ...
    if (openCategory) openCategory.addEventListener("click", (() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        if (heroBlock) heroBlock.addEventListener("click", (() => {
            ...
            new core(".hero-popup__slider", {
                modules: [ pagination_Pagination, navigation_Navigation ],
